 ...
 */
@HttpExchange
public interface SocketServiceWebClient extends SocketServiceClient {
     ...
     */
    @Override
    @PostExchange("multipleUnicast/ack")
     ...
     */
    @Override
    @PostExchange("getClientOperatingSystem/{deviceIdentified}")
