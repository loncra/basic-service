...
@Component
public class ManagedSkillSourceResolver implements SkillSourceResolver {

    @Override
    public boolean isSupport(String type) {
        return SkillSourceTypeEnum.MANAGED.toString().equals(type);
    }

    @Override
    public Path materialize(String packageKey, AbstractSkillSourceMetadata metadata) {
        throw new SystemException("MANAGED 来源物化尚未实现: " + packageKey);
    }
}
